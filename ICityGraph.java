...
/**
 * This interface extends the pre existing GraphADT, but adds functionality
 * for a MST, and also only works on String (representing cities) and Edge objects.
 */
public interface ICityGraph<NodeType, EdgeType extends Number> {
    // /**
    //  * Implements Kruskal's algorithm to find a MST for the internal CityGraph
    //  * 
    //  * @return a MST of the internal CityGraph
    //  */
    // public ICityGraph<String, Integer> minimumSpanningTree();
